    ...
    <div className="space-y-4 max-w-6xl">
      ...
      <Tabs defaultValue="logs" className="w-full">
        <TabsList className="bg-muted/50 border border-border">
          <TabsTrigger value="logs" className="text-xs font-mono data-[state=active]:text-primary">
            Request Logs
          </TabsTrigger>
          <TabsTrigger value="uptime" className="text-xs font-mono data-[state=active]:text-primary">
            Uptime Monitor
          </TabsTrigger>
        </TabsList>
